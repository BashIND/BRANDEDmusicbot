...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"ZexxOp/assets/ZexxOp.png")
        ...
        font = ImageFont.truetype("ZexxOp/assets/font2.ttf", 45)
        ImageFont.truetype("ZexxOp/assets/font2.ttf", 70)
        arial = ImageFont.truetype("ZexxOp/assets/font2.ttf", 65)
        ImageFont.truetype("ZexxOp/assets/font.ttf", 30)
